...
Функция НовоеРасписаниеРегламентногоЗадания(ВремяНачала, ВремяКонца, ПериодПовтораВТечениеДня = 60) Экспорт 
	
	РасписаниеРегламентногоЗадания = Новый РасписаниеРегламентногоЗадания;
	РасписаниеРегламентногоЗадания.ПериодПовтораДней = 0;  // один раз в день
	РасписаниеРегламентногоЗадания.ВремяНачала = ВремяНачала;
	РасписаниеРегламентногоЗадания.ВремяКонца = ВремяКонца;
