...
// Функция - Существует регламентное задание
//
// Параметры:
//  КлючПоиска	 - Строка - см.КлючЗадания(); 
// 
// Возвращаемое значение:
//   - 
//
Функция СуществуетРегламентноеЗадание(КлючПоиска) Экспорт 
	
	Отбор = НовыйОтборРегламентногоЗадания(КлючПоиска);
...
// Процедура - Удалить регламентное задание
//
// Параметры:
//  Ссылка	 - СправочникСсылка.Номенклатура	 - 
//
Процедура УдалитьРегламентноеЗадание(Знач Ссылка) Экспорт 
...
Функция СгенерироватьОтложенноеЗадание(Знач НоменклатураСсылка, ПараметрыРегламентногоЗадания, РасписаниеРегламентногоЗадания) Экспорт 
	...
	Если СуществуетРегламентноеЗадание(КлючЗадания(НоменклатураСсылка)) Тогда
